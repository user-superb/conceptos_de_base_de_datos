...
begin
  ...
  // Se busca el mínimo dentro del arreglo de mínimos
  // donde se elige el registro con la menor cod. provincia y la menor cod. localidad.
  for i:= 2 to N do
  begin
...
begin
  ...
  // ACLARACIÓN: El archivo maestro está ordenado y tiene todas las provincias. Se exime la necesidad de verificar si se alcanzó el EOF.
  ...
  seek(mae, Filepos(mae) - 1); write(mae, aux_reg);
end;
